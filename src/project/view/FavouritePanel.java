...
import project.controller.DeleteFavCocktail;
...
public class FavouritePanel  extends JPanel {
    public FavouritePanel(String cocktailname,String cocktailimg,String id){
        ...
        JButton button=new JButton("Delete Favourite");
        DeleteFavCocktail delbutton= new DeleteFavCocktail(id);
        button.addActionListener(delbutton);
